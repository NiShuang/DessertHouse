...
/**
 * Servlet implementation class ShowOneClerkServlet
 */
@WebServlet("/ShowOneClerkServlet")
public class ShowOneClerkServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		context.getRequestDispatcher("/admin/modifyClerk.jsp").forward(request, response);
	}
