...
if(request.getAttribute("place")==null) 
      request.getRequestDispatcher("/PlaceServlet").forward(request, response);
  else 
	   result = (List)request.getAttribute("place");
  	%>
<div class="frame">
...
<div class="menu">
	<ul>
        ...
        <li class="selected"><a href="http://localhost:8080/DessertHouseWeb/PlaceServlet">居住地分布</a></li>
...
$(document).ready(function() {  
   ...
   var series= [{
      ...
      data: [       <%    for(Iterator iterator=result.iterator();iterator.hasNext();){
          ...
          ['<%=obj[0]%>',  <%=Integer.parseInt(String.valueOf(obj[1]))%> ],
       <%}%>
