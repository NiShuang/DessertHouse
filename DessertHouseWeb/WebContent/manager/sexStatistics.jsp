...
if(request.getAttribute("sex")==null) 
      request.getRequestDispatcher("/SexServlet").forward(request, response);
  else 
	   result = (List)request.getAttribute("sex");
  	%>
<div class="frame">
...
<div class="menu">
	<ul>
        ...
        <li class="selected"><a href="http://localhost:8080/DessertHouseWeb/SexServlet">性别比例</a></li>
...
$(document).ready(function() {  
   ...
   var series= [{
      ...
      data: [       <%    for(Iterator iterator=result.iterator();iterator.hasNext();){
          ...
          String sex = "男";
          if(String.valueOf(obj[0]).equals("2"))
          	sex="女";%>

          ['<%=sex%>',  <%=Integer.parseInt(String.valueOf(obj[1]))%> ],
       <%}%>
